    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
        <div style={{
          ...
          <Database style={{ height: "1.5rem", width: "1.5rem", color: "white" }} />
        </div>
        ...
        <div style={{ flex: 1, paddingRight: "2rem" }}>
          ...
          <p style={{
            ...
            Would you like to populate it with sample data? This will add 8 agents, 4 policies,
            and ~2,000 audit entries to help you explore ChronoGuard's features.
          </p>
          ...
          <div style={{ display: "flex", gap: "0.75rem" }}>
            ...
            <button
              ...
              onMouseEnter={(e) => !isSeeding && (e.currentTarget.style.backgroundColor = "#f9fafb")}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = "transparent"}
            >
              I'll do it later
            </button>
