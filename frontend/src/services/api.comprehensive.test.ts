...
import type { AuditQueryRequest, CreateAgentRequest, CreatePolicyRequest, UpdateAgentRequest, UpdatePolicyRequest } from '@/types/api';
...
describe('API Comprehensive Coverage', () => {
  describe('Type Definitions', () => {
    ...
    it('should handle all decision types', () => {
      const decisions = ['allow', 'deny', 'block', 'rate_limited', 'time_restricted', 'policy_violation'];
    ...
    it('should handle all agent statuses', () => {
      const statuses: Array<'active' | 'suspended' | 'pending_activation' | 'expired'> = [
        'active',
        'suspended',
        'pending_activation',
        'expired',
